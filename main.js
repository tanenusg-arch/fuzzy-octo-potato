...
function initBot() {
    ...
    try {
        ...
        // Quick command menu + handlers
        // These commands mirror the main inline-menu destinations.
        bot.setMyCommands([
            ...
            // Explicitly force Telegram's bottom-left Menu button to show the command list.
            // setMyCommands alone registers the commands, but does not guarantee the
            // chat menu button is configured as the Commands menu.
            return bot.setChatMenuButton({
                menu_button: { type: 'commands' }
            });
        }).catch(err => console.error('Failed to configure bot command menu:', err?.message || err));
